...
from django.contrib.gis.db import models  # Using GeoDjango models layer for GIS tracking
...
class Property(models.Model):
    ...
    cover_image = models.ImageField(upload_to='properties/covers/', null=True, blank=True)
...
class Unit(models.Model):
    STATUS_CHOICES = (('AVAILABLE', 'Available'), ('RESERVED', 'Reserved'), ('OCCUPIED', 'Occupied'), ('MAINTENANCE', 'Maintenance'))
    ...
    occupancy_status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='AVAILABLE')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
